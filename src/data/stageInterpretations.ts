...
const AU_DATA: AnchorStageData = {
  ...
  senior: {
    high: {
      ...
      development: { "zh-CN": "认真审视你的处境：1）你是否有足够的专业资本和财务储备来实现完全自主？如果有，为什么还没行动？2）如果没有，是否可以通过跨部门项目、咨询、自由职业逐步过渡？3）是否可以在现有组织内部谈判更大的自主空间？最危险的状态是「想走但不行动」——这会让你慢慢在抱怨中消耗掉。", "zh-TW": "認真審視處境：是否有足夠資本實現自主？是否可以逐步過渡？是否可以內部談判？最危險的是「想走但不行動」。", en: "Honestly assess your situation: 1) Do you have enough professional capital and financial reserves for full autonomy? If yes, why haven't you acted? 2) If not, can you transition gradually through side work, consulting, or freelancing? 3) Can you negotiate more autonomy within your current organization? The most dangerous state is 'wanting to leave but not acting'—this slowly consumes you in resentment." },
...
const SE_DATA: AnchorStageData = {
  ...
  mid: {
    ...
    moderate: {
      ...
      development: { "zh-CN": "这是一个很好的状态。利用你的安全基础去探索一些有趣但有风险的方向——跨领域尝试、学习新技能、或者在公司内部尝试新项目。", "zh-TW": "利用你的安全基礎探索有趣方向——跨領域嘗試、新技能、新專案。", en: "This is a good position. Use your security base to explore interesting but risky directions—side projects, new skills, or internal ventures." },
  ...
  executive: {
    ...
    low: {
      ...
      risk: { "zh-CN": "风险：忽视团队对稳定性的需求。不是每个人都和你一样享受不确定性。", "zh-TW": "風險：忽視團隊對穩定性的需求。不是每個人都像你一樣能在不確定性中發揮。", en: "Risk: Ignoring your team's need for stability. Not everyone thrives in uncertainty like you do." },
    },
  },
};
...
const EC_DATA: AnchorStageData = {
  ...
  senior: {
    ...
    moderate: {
      meaning: { "zh-CN": "10年以上中等EC，你的创业热情可能已经沉淀——不再是年轻时的冲动，而是一种沉稳的创造欲。你可能在组织内部找到了满足创新需求的方式，也可能在「自主专案」中释放创业能量。", "zh-TW": "10年以上中等EC，創業熱情已沉澱，可能在組織內找到了創新滿足的方式，或在自主專案中釋放創業能量。", en: "Moderate EC after 10+ years—entrepreneurial enthusiasm has settled from youthful impulse to calm creative desire. You may have found ways to satisfy innovation needs within organizations or channel energy through side projects." },
      characteristics: { "zh-CN": ["对创新仍有兴趣但不再有紧迫感", "可能通过组织内部创新获得了满足", "对创业的风险回报计算更加理性", "可能已经尝试过自主专案或轻创业"], "zh-TW": ["對創新仍有興趣但不再有緊迫感", "通過組織內部創新獲得了滿足", "對創業風險計算更理性", "可能嘗試過自主專案"], en: ["Still interested in innovation but without urgency", "May have found satisfaction through internal innovation", "More rational about entrepreneurial risk-reward", "May have tried side projects or light entrepreneurship"] },
