-- ============================================================
-- Anonymous Assessment Center — Database Schema
-- ============================================================

-- 1. Anonymous Assessment Batches
...
-- 3. Anonymous Assessment Responses
...
-- 5. Anonymous Assessment Permissions
...
-- Batches: authenticated users can read/write (admin check done in app)
...
-- Links: authenticated can manage; anon can read by token for participant access
...
-- Responses: authenticated can read; anon can insert (submit assessment)
